...
```{r}
myData$PCUSEFREQ <- factor(myData$PCUSEFREQ, levels = c(1, 2, 3, 4), labels = c("Infrequent", "Infrequent", "Frequent", "Frequent"))
```
...
```{r}
myData$DEPRX <- factor(myData$DEPRX, levels = c(1, 0), labels = c("Yes", "No"))
```
