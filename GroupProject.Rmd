...
logit(GoodHealth)=β0+β1SexualMinority+β2NonWhiteRace+β3(SexualMinority×NonWhiteRace)+β′X
...
6. Hispanic Ethnicity [HISPYN](https://nhis.ipums.org/nhis-action/variables/group?id=demographic_ethnicity)
